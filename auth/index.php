...
<head>
  ...
  <title>DATA RENTAL MOBIL - Login</title>
              ...
              <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                  <div class="login-brand">
                    <img src="../assets/img/media.svg" alt="logo" width="100" class="shadow-light rounded-circle">
                  </div>
                ...
                <div class="simple-footer">
                  Copyright &copy; Aplikasi Rental Mobil By Dwityananda
                </div>
              </div>
            </div>
          </div>
